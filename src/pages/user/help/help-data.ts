...
export const helpList = [
    ...
    },
    {
        ...
        content: [
            ...
            `We don't accept deposits from third parties, payments must be made in your own name which has been verified with Manilla Exchange.`,
        ],
        table: {
            header: [
                'Currency',
    ...
    },
    {
        ...
        content: [
            ...
            If you wish to use a company bank account to make deposits from Manilla, please apply for a company account at Manilla Exchange.`,
