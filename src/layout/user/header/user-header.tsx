          ...
          <ul>
            <li>
              <div className="text-center">
                <NavLink to="/about" className={({isActive}) => isActive ? 'selected-nav' : ''}>
                  <span>Buy</span>
                </NavLink>
              </div>
            </li>
            <li>
              <div className="text-center">
                <NavLink to="/projects" className={({isActive}) => isActive ? 'selected-nav' : ''}>
                  <span>Sell</span>
                </NavLink>
              </div>
            </li>
            <li>
              <div className="text-center">
                <NavLink to="/news" className={({isActive}) => isActive ? 'selected-nav' : ''}>
